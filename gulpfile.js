...
// 拷贝libs/js
gulp.task("TASK_COPY_LIBS_JS", function() {
    return gulp
        .src([path.join(PATHS.LIBS, 'js/**/*.js')])
        .pipe(gulp.dest(PATHS.JS))
});
// 拷贝libs/css
gulp.task("TASK_COPY_LIBS_CSS", function() {
    return gulp
        .src([path.join(PATHS.LIBS , 'css/**/*.css')])
        .pipe(gulp.dest(PATHS.CSS))
});
...
// 默认
gulp.task("default", [USER_CONFIG.MOD, "TASK_COPY_LIBS_JS"], function() {
